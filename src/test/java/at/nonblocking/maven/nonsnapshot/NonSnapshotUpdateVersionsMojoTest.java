...
public class NonSnapshotUpdateVersionsMojoTest {
  ...
  @Test
  public void testUpdateUpstreamDependencyVersionsDependencyManagement() throws Exception {
    ...
    wsArtifact2.getDependencies().add(new MavenModuleDependency(-1, wsArtifact1));
    wsArtifact2.getDependencyManagements().add(new MavenModuleDependency(0, upstreamDep1));
  ...
  @Test
  public void testUpdateUpstreamDependencyVersionsProperties() throws Exception {
    ...
    wsArtifact2.getDependencies().add(new MavenModuleDependency(-1, wsArtifact1));
    MavenProperty mavenProperty = new MavenProperty("propertyName", 0);
    mavenProperty.getPropertyReferencingModuleDependency().add(new MavenModuleDependency(0, upstreamDep1));
    wsArtifact2.getMavenProperties().add(mavenProperty);
